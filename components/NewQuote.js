...
import { KeyboardAvoidingView, Platform, Modal, StyleSheet, TextInput } from "react-native";
...
export default function NewQuote({ visible, onCancel, onSave }) {
  ...
  return (
    <Modal visible={visible} onRequestClose={cancelEditing} animationType="slide">
